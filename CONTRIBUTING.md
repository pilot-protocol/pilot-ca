...
Thanks for your interest in contributing to `pilot-ca` — Offline root-CA tooling for Pilot Protocol — Ed25519 root + leaf cert issuance for compat-mode beacon WSS endpoints.

## Quick start

```bash
git clone https://github.com/pilot-protocol/pilot-ca.git
cd pilot-ca
go test -race ./...
```
